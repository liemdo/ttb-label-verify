      ...
      <div className="relative group rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900/50">
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
          <button
            ...
            className="p-2 rounded-full bg-zinc-900/80 text-zinc-200 hover:bg-zinc-800 transition-colors backdrop-blur-sm"
            title="Zoom image"
          >
        ...
        {/* File info footer */}
        <div className="absolute bottom-0 left-0 right-0 bg-zinc-950/80 backdrop-blur-md p-2.5 border-t border-zinc-800/50 flex items-center justify-between">
          <span className="text-xs font-medium text-zinc-300 truncate pr-4">
            {file.name}
          </span>
        ...
        <DialogContent className="max-w-5xl w-[90vw] h-[90vh] p-0 bg-transparent border-none shadow-none flex flex-col">
          ...
          <div className="flex justify-end p-4">
            <button
              ...
              className="p-2 rounded-full bg-zinc-900/80 text-zinc-200 hover:bg-zinc-800 transition-colors backdrop-blur-sm border border-zinc-700"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
