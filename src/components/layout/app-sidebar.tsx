    ...
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-zinc-950 border-r border-zinc-800 flex flex-col z-50">
      ...
      <div className="px-5 py-5 border-b border-zinc-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-sm font-bold text-white tracking-tight">TTB Label Verify</h1>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest">Compliance Tool</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-2 text-xs">
          {settings.ocrEngine === "openai" ? (
            <>
              ...
              <span className="text-zinc-400">AI Mode</span>
