...
export function KeyboardHints() {
  return (
    <Tooltip>
      <TooltipTrigger className="flex items-center gap-1.5 text-xs text-zinc-500 hover:text-zinc-300 transition-colors px-2 py-1 rounded-md hover:bg-zinc-800">
        ...
        <div className="space-y-1.5">
          ...
          {SHORTCUT_DEFINITIONS.map((s) => (
            <div key={s.key} className="flex items-center justify-between text-xs">
              ...
              <kbd className="px-1.5 py-0.5 rounded bg-zinc-700 text-zinc-300 text-[10px] font-mono border border-zinc-600">
